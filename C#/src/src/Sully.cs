...
namespace DrQuine
{
	public class Sully
	{
		...
		private static void CompileRun(string file, string code)
		{
			...
			Process cc = new Process(); cc.StartInfo.FileName = "mcs"; cc.StartInfo.Arguments = file + $" -out:Sully_{n}"; cc.Start(); cc.WaitForExit();
			Process cmd = new Process(); cmd.StartInfo.FileName = "mono"; cmd.StartInfo.Arguments = $"Sully_{n}"; cmd.Start();
		}
